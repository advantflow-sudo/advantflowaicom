...
const Auth = () => {
  ...
  // FIX: track sign-up confirmation state so we can show a helpful message instead of leaving user stranded
  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error;
        // FIX: show a dedicated confirmation screen instead of a toast that disappears
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6 relative">
      ...
      >
        ...
        <div className="bg-card border border-border rounded-3xl p-8 md:p-10">
          ...
          {/* FIX: Show confirmation screen after sign-up instead of leaving user on the form */}
          {awaitingConfirmation ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-muted-foreground mb-8">
                Click the link in the email to activate your account and you'll be taken straight to your portal.
              </p>
              <button
                onClick={() => {
            ...
            <>
              ...
              <p className="text-muted-foreground mb-8">
                {isLogin ? "Sign in to your client portal" : "Get started with your client portal"}
              </p>
