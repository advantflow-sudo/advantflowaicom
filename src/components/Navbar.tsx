...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="container-wide section-padding py-4 md:py-5 flex items-center justify-between">
        {/* Logo */}
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            <nav className="container-wide section-padding py-6 flex flex-col gap-4">
              {navLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
